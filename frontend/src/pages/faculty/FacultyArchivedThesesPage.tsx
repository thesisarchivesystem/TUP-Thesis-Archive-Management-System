      ...
      <div className="space-y-5">
        ...
        <section className="student-submissions-stats">
          {stats.map(({ label, value, icon: Icon, tone }) => (
            <article key={label} className="student-submissions-stat-card faculty-archived-theses-stat-card">
              <div className="student-submissions-stat-copy">
                <span>{label}</span>
                <strong>{value}</strong>
              </div>
              <span
                className="student-submissions-stat-icon faculty-archived-theses-stat-icon"
                style={{
                  background:
