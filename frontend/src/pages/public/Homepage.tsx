...
function HomePageStyles() {
  return (
    <style>{`
      ...
      .homepage-color-theme-control{position:fixed;top:86px;right:34px;z-index:999;display:inline-flex;align-items:center;justify-content:center}.homepage-color-theme-control .book-color-theme-trigger{width:34px;height:34px}.homepage-color-theme-control .book-color-theme-trigger::after{inset:8px}.homepage-color-theme-control .book-color-theme-popover{right:calc(100% + 14px)}.homepage-color-theme-control .book-color-theme-hint{display:none}
...
export default function Homepage() {
  ...
  return (
    <div className="homepage-shell" data-theme={theme} style={bookThemeStyle}>
      <HomePageStyles />
      ...
      <div className="homepage-color-theme-control">
